...
namespace UIDE.CodeCompletion {
	public class ReflectionDB:System.Object {
		[NonSerialized]
		public bool needsToBeKilled = true;
		...
		public void UpdateCurrentState(bool updateReflection) {
			...
			FinializeUpdateReflectionDatabase();
			...
			//	Debug.Log(currentCompletionItems[i].name);
		...
		*/
		...
		public void FinializeUpdateReflectionDatabase() {
