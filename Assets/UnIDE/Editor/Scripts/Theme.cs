...
namespace UIDE {
	...
	public class Theme:System.Object {
		static public string themesFolder {
			get {
				return UIDEEditor.baseDir+"Editor/Themes/";
			}
		}
		...
		public Color errorColor = new Color(1.0f,0.14453125f,0.14453125f,0.546875f);
		public Color warningColor = new Color(1.0f,0.859375f,0.15234375f,0.234375f);
		public Color assertColor = new Color(0.75f,0.75f,0.75f,0.25f);
